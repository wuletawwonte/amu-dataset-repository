...
<body>
         ...
         <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="<?php echo base_url(); ?>welcome/editUserProfileView"><i class="fa fa-user"></i> Profile</a></li>
   ...
   <div class="container col-lg-8 col-lg-offset-2" id="adminBody">
	   ...
	   <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>welcome/editUserAccount" role="form" id="createAccountForm">
	      <div class="form-group">
	        <label  class="col-sm-4 control-label"
	                  for="username">Username</label>
	        <div class="col-sm-8">
	            <input type="text" class="form-control" 
	            name="username" value="<?php echo $this->session->userdata('username'); ?>" readonly/>
	        </div>
	      </div>
